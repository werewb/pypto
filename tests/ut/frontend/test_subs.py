"""Dynamic subs (scalar subtraction) tests for the @fe.kernel decorator.

Tests the subs operation: out = tile - scalar
    ...
    with pl.section_vector():
        ...
        for i in pl.range(0, M_dim, 64):
            for j in pl.range(0, N_dim, 64):
                ...
                plm.subs(tile_out, tile_a, SUB_VALUE)
...
def test_dynamic_subs():
    compiled_lib = fe.compile(dynamic_subs_kernel, arch="dav-c220-vec")

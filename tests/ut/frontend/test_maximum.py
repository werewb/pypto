"""Dynamic maximum tests for the @fe.kernel decorator.

Tests the maximum operation: out = max(lhs, rhs)
Used in FlashAttention for updating global maximum in online softmax.
"""
    ...
    with pl.section_vector():
        ...
        for i in pl.range(0, M_dim, 64):
            for j in pl.range(0, N_dim, 64):
                ...
                plm.maximum(tile_out, tile_a, tile_b)
